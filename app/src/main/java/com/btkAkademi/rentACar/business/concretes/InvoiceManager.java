...
public class InvoiceManager implements InvoiceService{
	...
	public DataResult<InvoiceIndividualCustomerDto> getInvoiceForIndividualCustomer(int rentalId) {
		...
		var payments=paymentService.getByRentalId(rentalId).getData();
		...
		return new SuccessDataResult<InvoiceIndividualCustomerDto>(responseCustomerDto,"Bireysel müşteri faturası");
	}
	...
	public DataResult<InvoiceCorporateCustomerDto> getInvoiceForCorporateCustomer(int rentalId) {
		...
		return new SuccessDataResult<InvoiceCorporateCustomerDto>(responseCustomerDto, "Kurumsal faturası");
