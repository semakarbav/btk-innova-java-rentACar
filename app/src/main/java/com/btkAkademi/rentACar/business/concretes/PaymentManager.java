...
public class PaymentManager  implements PaymentService{
	...
	public Result add(CreatePaymentRequest createPaymentRequest) {
        ...
        double totalPrice = totalPriceCalculator(rental,createPaymentRequest.getPromotionCode() );
	...
	private double totalPriceCalculator(RentalListDto rental,String promotionCode) {
		double total = 0.0;
		...
		// discount
			if(promotionCode !=null) { 
				double discount = 0;
				discount= promotionService.getByPromotionCode(promotionCode).getData().getDiscount();
	...
	@Override
	public DataResult<Double> getTotalSumByRentalId(int rentalId) {
		RentalListDto rental=rentalService.getById(rentalId).getData();
		return new SuccessDataResult<Double>(this.totalPriceCalculator(rental, null));
	}
